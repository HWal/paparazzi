...
void imu_impl_init(void)
{
  ...
  /* No magnetometer in SEN-10121 */
  /* initialize mag and set default options */
  // hmc58xx_init(&imu_sen10121.mag_hmc, &(IMU_SEN10121_I2C_DEV), HMC58XX_ADDR);
  /* set the type to the old HMC5843 */
  // imu_sen10121.mag_hmc.type = HMC_TYPE_5843;
}
...
void imu_periodic(void)
{
  ...
  // RunOnceEvery(10, hmc58xx_periodic(&imu_sen10121.mag_hmc));
}
...
void imu_sen10121_event(void)
{
  ...
  /* No magnetometer in SEN-10121 */
  /* HMC58XX event task */
  /* hmc58xx_event(&imu_sen10121.mag_hmc);
  if (imu_sen10121.mag_hmc.data_available) {
    imu.mag_unscaled.x = -imu_sen10121.mag_hmc.data.vect.y;
    imu.mag_unscaled.y = -imu_sen10121.mag_hmc.data.vect.x;
    imu.mag_unscaled.z = -imu_sen10121.mag_hmc.data.vect.z;
    imu_sen10121.mag_hmc.data_available = FALSE;
    imu_scale_mag(&imu);
    AbiSendMsgIMU_MAG_INT32(IMU_SEN10121_ID, now_ts, &imu.mag);
  } */
}
